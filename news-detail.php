...
if (isset($_POST['submit'])) {
    if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
        ...
        if ($responseData->success) {
            ...
            if (@$fbid != "") {
                $query = "insert into comments(post_id, fbId, name, comment, date, ip) values ('$postid','$fbid','$name','$comment',now(),'$myip')";
...
<head>
    <meta charset="UTF-8" />
    <title><?php echo htmlspecialchars_decode($row->title); ?>  | Natural Direct Co. Ltd</title>
    ...
    <div class="container group">
        <div class="row">
            ...
            <div id="content-blog" class="span9 content group">
                ...
                <!-- START COMMENTS -->
                <div class="section blog span6" style="margin-left:10%">
                ...
                <!-- Leave a comment-->
                <div id="comments" style="margin-left:10%">
                    <div id="respond">
                        ...
                        <?php if (@$_SESSION['name'] != "" or @ $_SESSION['fb_name'] != "") { ?>
                            ...
                            ?>" size="30" aria-required='true'/>
                                    ...
                                    <?php if (@$fbID != "") { ?>
                                        <input type="hidden" name="fbid" value="<?php echo$fbID[0] ?>" />
                                    <?php } ?>
                                    <?php if (@$userID != "") { ?>
                                    ...
                                    <p class="comment-form-comment span9"><label class="hide-label" for="comment">Your
                                            comment</label><i class="icon-pencil"></i><textarea id="comment" name="comment" cols="45" rows="8" required><?php echo @$_POST['comment'] ?></textarea>
                                                                    </p>
                                                                    <div class="clear"></div>
                                                                    <div class="span9">
                        ...
                        <?php
                            ...
                            echo "<p style=\"font-size:20px;\">Please <a style=\"font-size:20px;\" href=\"./members/members.php\">login</a> first.</p>";
                        }
                        ?>
                                                </div>
                                                <!-- #respond -->
