...
<html>
    <head>
        ...
        <title>Autism Test - <?php echo"$rowtitle[0]"; ?></title>
    ...
    if (isset($_POST["Finish"])) {
        ...
        if ($resultsql) {
            ...
            while ($row = $resultsql->fetch_assoc()) {
                if ($_POST[$row["id"]] == "da" || $_POST[$row["id"]] == "sa") {
                    $temp = "agree";
                } else {
                    $temp = "disagree";
                }
        ...
        $sql2 = "update user set mark ='" . $mark . "' where userID ='" . $No . "'";
        $resultsql2 = mysqli_query($conn, $sql2);
        if ($resultsql2) {
            echo "<center>Your mark is " . $mark . "</center><br>";
            if ($mark <= 16) {
                echo "<center>Congratulations! You have no any autism.</center><br><br>";
            } elseif ($mark > 16 && $mark <= 32) {
                echo "<center>Normally, You have little autism.</center><br><br>";
            } else {
                echo "<center>Importantly, You have severe autism.</center><br><br>";
            }
            include 'start.php';
        }
         }else{
    ...
    } elseif (isset($_SESSION["No"]) || isset($_SESSION["fb_id"])) {
        if (isset($_SESSION["No"])) {
            ...
            if ($user != "fail" && $pw != "fail") {
                echo "<center>Your latest mark is " . $mark . "</center><br>";
                if ($mark <= 16) {
                    echo "<center>Congratulations! You have no any autism.</center><br><br>";
                } elseif ($mark > 16 && $mark <= 32) {
                    echo "<center>Normally, You have little autism.</center><br><br>";
