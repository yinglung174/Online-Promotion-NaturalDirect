...
<html>
    <head>
        ...
        <title>wePlant - <?php echo"$rowtitle[1]"; ?></title>
                            ...
                            <div class="services-row row group">
                                ...
                                <div id="span3" class="span5" style=" ">
                                    <div class="circle-services">
                                        <div class="ch-item " style="background-image: url(images/weplant.jpg);"></div>
                                    </div>

                                    <h4>we<span class="title-highlight">weplant</span></h4>
