                ...
                <div class="page type-page status-publish group">
                    ...
                    <div class="row">
                        <ul id="portfolio" class="slide-detail detail thumbnails">
                            <?php
                            //get activity image
                            $a_query = "SELECT path, category, date from images GROUP by category order by date desc";
                                ...
                                echo "<li class=\"first slide-1 filterable_item span3 activity\">
                                    ...
                                    <div class=\"ch-info\">
                                        <div class=\"ch-info-icons\">
                                            <a href=\"portfolio-details.php?category=$a_img[1]\">
                                                <img src=\"images/icons/set_icons/pictures48.png\" alt=\"Open Album\" />
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <a href=\"portfolio-details.php?category=$a_img[1]\"><p class=\"center\"><b>Album: $a_img[1]<br> Date: $a_img[2]</b></p></a>
                            </li>";
                            }
                            ?>
                        </ul>
